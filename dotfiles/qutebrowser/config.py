...
## Follow the palette generated by Omarchy's active theme. This is kept here
## instead of being baked into qutebrowser's config so theme changes take
## effect the next time qutebrowser starts without duplicating colors.
import os
import re
...
def _omarchy_colors():
    ...
    # Older themes use the short names; canonical values win when both exist.
    aliases = {
        'background': 'bg',
...
theme = _omarchy_colors()
bg = theme['background']
dark_bg = theme['dark_background']
darker_bg = theme['darker_background']
light_bg = theme['lighter_background']
fg = theme['foreground']
dark_fg = theme['dark_foreground']
...
green = theme['green']
cyan = theme['cyan']
blue = theme.get('bright_blue', theme['blue'])
...
c.colors.completion.fg = [fg, accent, dark_fg]
...
c.colors.completion.item.selected.fg = dark_bg
c.colors.completion.item.selected.match.fg = dark_bg
c.colors.completion.match.fg = blue
c.colors.completion.odd.bg = dark_bg
c.colors.completion.scrollbar.bg = muted
...
c.colors.downloads.error.fg = bright_fg
c.colors.hints.bg = accent
c.colors.hints.fg = dark_bg
c.colors.hints.match.fg = red
c.colors.keyhint.bg = dark_bg
...
c.colors.tabs.selected.even.fg = dark_bg
c.colors.tabs.selected.odd.bg = accent
c.colors.tabs.selected.odd.fg = dark_bg
...
c.colors.webpage.preferred_color_scheme = theme['mode']
c.colors.webpage.darkmode.enabled = theme['mode'] == 'dark'
